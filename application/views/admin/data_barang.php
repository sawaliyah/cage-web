            ...
            <div class="modal-body">
                <form action="<?php echo base_url() . 'admin/data_barang/tambah_aksi'; ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_brg" required oninvalid="this.setCustomValidity('Nama barang wajib diisi !')" oninput="setCustomValidity('')">
                    </div>
                    <div class="form-group">
                        <label for="ket">Keterangan</label>
                        <input type="text" class="form-control" name="keterangan" required oninvalid="this.setCustomValidity('Deksripsi barang wajib diisi !')" oninput="setCustomValidity('')">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" name="harga" required oninvalid="this.setCustomValidity('Harga barang wajib diisi !')" oninput="setCustomValidity('')">
                    </div>
                    <div class="form-group">
                        <label for="stk">Stok</label>
                        <input type="number" class="form-control" name="stok" required oninvalid="this.setCustomValidity('Stok barang wajib diisi !')" oninput="setCustomValidity('')">
                    </div>
                    <div class="form-group">
